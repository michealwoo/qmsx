...
class Team_EweiShopV2Page extends AppMobilePage 
{
	...
	public function details() 
	{
		...
		app_json(array( "data" => array( "myorder" => $myorder, "tuan_first_order" => $tuan_first_order, "shopshare" => $shopshare, "lasttime2" => $lasttime2, "n" => $n, "nn" => $nn, "ladder" => $ladder, "goods" => $goods, "orders" => $orders, "uid" => $member["id"], "arr" => $arr ) ));
	}
}
?>