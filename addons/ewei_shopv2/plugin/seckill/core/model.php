...
class SeckillModel extends PluginModel 
{
	...
	public function checkBuy($seckillinfo, $title, $unit = "") 
	{
		...
		if( !empty($seckillinfo["options"]) ) 
		{
			...
			$redis_key = (string) $_W["uniacid"] . "_seckill_stock_" . $seckillgoodsinfo["taskid"] . "_" . $seckillgoodsinfo["roomid"] . "_" . $seckillgoodsinfo["timeid"] . "_" . $seckillgoodsinfo["goodsid"] . "_" . $seckillgoodsinfo["optionid"];
			$redis = redis();
