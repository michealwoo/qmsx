...
class Index_EweiShopV2Page extends PluginMobileLoginPage 
{
	...
	private function sendBargainResult($openid, $cut_price, $now_price, $nickname, $iORr, $sORf, $last = 0) 
	{
		...
		if( $last == 1 ) 
		{
			$tag = "bargain_fprice";
			$text = "砍到底价通知：\n\n[砍价人昵称]帮您砍到底价了，\n砍价结果：[砍掉或增加]了[砍价金额]元\n砍价时间：[砍价时间]\n当前成交价：[当前金额]元\n\n<a href='" . $url . "'>点击查看详情</a>";
			$message = array( "first" => array( "value" => "砍到底价通知\n", "color" => "#000000" ), "keyword1" => array( "title" => "任务名称", "value" => (string) $nickname . "帮你砍到底价", "color" => "#000000" ), "keyword2" => array( "title" => "通知类型", "value" => "砍到底价通知", "color" => "#000000" ), "remark" => array( "value" => "砍价金额：" . $iORr . "了" . $cut_price . "元\n砍价时间：" . $time . "\n当前价格：" . $now_price . "元\n\n点击立即下单", "color" => "#000000" ) );
		}
		else 
		{
			$tag = "bargain_message";
			$text = "砍价成功通知：\n\n" . $nickname . "帮您砍价" . $sORf . "，\n砍价结果：" . $iORr . "了" . $cut_price . "元\n砍价时间：" . $time . "\n当前成交价：" . $now_price . "元\n" . $remark;
			$message = array( "first" => array( "value" => "砍价" . $sORf . "通知\n", "color" => "#000000" ), "keyword1" => array( "title" => "任务名称", "value" => (string) $nickname . "帮你砍价" . $sORf, "color" => "#000000" ), "keyword2" => array( "title" => "通知类型", "value" => "砍价" . $sORf . "通知", "color" => "#000000" ), "remark" => array( "value" => "砍价金额：" . $iORr . "了" . $sORf . "元\n砍价时间：" . $time . "\n当前价格：" . $now_price . "元\n\n点击立即下单", "color" => "#000000" ) );
		}
