...
class Picker_EweiShopV2Page extends MobilePage 
{
	public function main() 
	{
		...
		$goods["giftid"] = $giftid;
		//会员折扣
		$goods['marketprice'] = m('common')->getmarketprice($_W['openid'],$goods['marketprice'],$goods['discounts']);
