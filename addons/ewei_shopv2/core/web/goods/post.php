...
if( $_W["ispost"] ) 
{
	...
	if( empty($id) ) 
	{
		...
		pdo_insert("price_log", array(
			...
			'quotedprice'=>$_GPC['marketprice'],
			'supplierid'=>$_GPC['supplier_id'],
			'createtime'=>time()
		));
