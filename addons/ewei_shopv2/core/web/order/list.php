...
class List_EweiShopV2Page extends WebPage 
{
	...
	public function setting() 
	{
		global $_W;
		global $_GPC;
		    // echo $this->template("order/list");exit;
		//$orderData = $this->orderData(6, "status5");
		include($this->template("order/setting"));
	}
