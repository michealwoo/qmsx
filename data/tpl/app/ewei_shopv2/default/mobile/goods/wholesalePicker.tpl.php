		...
		<div class="option-picker-inner picker-bulk">
			...
			<div class="header">
				...
				<div class="inner">
					...
					<small>￥</small><%(goods.marketprice).toFixed(2)%>-<%/if%>
					<small>￥</small><%goods.maxprice%>
				...
				<div class="body" id="body_<%item.id%>" data-id="<%item.id%>"  style="display: none;">
					...
					<div class="item optiondata" data-optionid="<%if  item.id < item2.id%><%options[item.id+'_'+item2.id].id%><%else%><%options[item2.id+'_'+item.id].id%><%/if%>"  data-total="0">
						...
						<div class="right">
							...
							<div class="total">库存:<span class="stock">	

							  <%if  item.id < item2.id%><%options[item.id+"_"+item2.id].stock%><%else%><%options[item2.id+"_"+item.id].stock%><%/if%></span></div>
