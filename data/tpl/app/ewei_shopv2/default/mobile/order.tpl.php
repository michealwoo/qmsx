...
<div class='fui-page order-list-page '>
    ...
    <span class="btn btn-default btn-default-o" data-nocache="true"><%order.delivery_man_name%>&nbsp;<a href="tel:<%order.delivery_man_phone%>"><%order.delivery_man_phone%></a></span>
