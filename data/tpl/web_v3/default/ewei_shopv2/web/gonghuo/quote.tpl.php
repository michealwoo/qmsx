...
<div class="col-md-12">                
	...
	<th style="width: 125px;text-align:center;">操作</th>                    
		...
		<td>
			<a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo webUrl('gonghuo/change',array('type'=>'quotedprice','id'=>$row['id']))?>" ><?php  echo $row['quotedprice'];?></a>
