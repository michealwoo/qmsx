...
<div class="page-content">
    ...
    <div class="panel panel-default">
        ...
        <div class='panel-heading'>
            ...
            销售量：
            <span style="color:red;" id="ordercount"><?php  echo $totalcount;?></span>，
            最高销售量：
            <span style="color:red;" id="max_ordercount"><?php  echo $maxcount;?></span> 
...
//     var str = '<?php  echo $info['ajaxdata'];?>';
//     var json = eval('(' + str + ')');
//     myrequire(['echarts'], function () {
//     var lineChart = echarts.init(document.getElementById("echarts-line-chart"));
//     var lineoption = {
