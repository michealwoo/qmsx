	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-table-header">
				<input type="checkbox">
				<div class="btn-group">
					<?php if(cv('order.summary_delete')) { ?>                        
			...
			<table class="table table-responsive">
				...
				<tbody>
					<?php  if(is_array($data_)) { foreach($data_ as $row) { ?>                        
					<tr>                            
						<td style="position: relative; "><input type='checkbox' value="<?php  echo $row['id'];?>" class="checkone"/></td>
						<td style="overflow: visible">                                
							<span><?php  echo $row['goods_name'];?></span>                           
						</td>                            
						<td>                                
							<span><?php  echo $row['cname'];?></span>                          
						</td>   
						<td><span><?php  echo $row['_total'];?></span></td>                         
						<td>
							<span><span style="color: #5097d3"><?php  echo $row['fenbao'];?></span></span>
						</td>
					</tr>
					<?php  } } ?>
				</tbody>
