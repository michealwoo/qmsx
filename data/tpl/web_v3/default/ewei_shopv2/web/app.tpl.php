...
<div class="page-content">
    ...
    <div class="alert alert-primary">
        ...
        <p><a href=http://www.souho.net target=_blank>搜虎精品社区</a> | <a href=http://vip.souho.net target=_blank>极品商业源码</a> | <a href=http://idc.souho.net target=_blank>搜虎精品社区空间、域名</a> | <a href=http://vip.souho.net/templates/Korea/ target=_blank>90G韩国豪华商业模版</a> | <a href=http://www.souho.net/forum-158-1.html target=_blank>顶级棋牌商业源码</a></p>
    </div>
...
<a href="index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=app.page" class="btn btn-success btn-lg " style="margin-top: 15px;line-height: 12px;"  role="button">进入</a>
        ...
        <div class="wxapp-item" style="border: solid 1px #eaeaea;webkit-box-shadow: 0px 0px 17px rgba(0, 0, 0, 0.0);box-shadow: 0px 0px 17px rgba(0, 0, 0, 0.0);margin:0 20px 0 0;width: 240px">
		 ...
		 <div class="wxapp-item" style="border: solid 1px #eaeaea;webkit-box-shadow: 0px 0px 17px rgba(0, 0, 0, 0.0);box-shadow: 0px 0px 17px rgba(0, 0, 0, 0.0);margin:0 20px 0 0;width: 240px">
            ...
            <div class="name">营销海报</div>
            <div class="qrcode" style="border-radius: 10px">
                <img src="../addons/ewei_shopv2/static/images/shop5.png" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'" />
            </div>
            <div class="line"></div>
            <div class="text" style="padding: 20px 30px;">
            分销中心营销海报，可以设置多个海报方式，可自定义背景图。
			<a href="index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=app.poster" class="btn btn-success btn-lg " style="margin-top: 15px;line-height: 12px;"  role="button">进入</a>
		...
		<div class="wxapp-item" style="border: solid 1px #eaeaea;webkit-box-shadow: 0px 0px 17px rgba(0, 0, 0, 0.0);box-shadow: 0px 0px 17px rgba(0, 0, 0, 0.0);margin:0 20px 0 0;width: 240px">
            ...
            <div class="name">模板消息</div>
            <div class="qrcode" style="border-radius: 10px">
                <img src="../addons/ewei_shopv2/static/images/shop6.png" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'" />
            </div>
            <div class="line"></div>
            <div class="text" style="padding: 20px 30px;">
            下单通知等服务消息通知
			<a href="index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=app.tmessage" class="btn btn-success btn-lg " style="margin-top: 15px;line-height: 12px;"  role="button">进入</a>
